...
```{r}
avg_sleep <- median(nlsy$sleep_wknd, na.rm=TRUE)
avg_sleep
```
The median hours of sleep on weekends was `r median(nlsy$sleep_wknd, na.rm= TRUE)`
...
The median and IQR for hours of sleep on the weekend is `r mean_hrs_sleep`
